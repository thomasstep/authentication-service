...
API_ROUTE=v1/reset-password/send-email
SOURCE_BUCKET_NAME=source-bucket-s3bucket-1e6txaiywjvno
SOURCE_KEY=green-things-auth/v1/reset-password-send-email
TEMPLATE_PATH=./infrastructure/api.yml
STACK_NAME=green-things-auth
STACK_SOURCE_VERSION_PARAMETER_NAME=V1ResetPasswordEmailSourceVersion
